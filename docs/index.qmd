...
For more information about how data is processed and the chain of
dependencies supporting the LA Metro scraper to Councilmatic pipeline,
see [Data Flow](./dataflow.qmd).
